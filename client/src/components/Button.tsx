...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    secondary: 'bg-white dark:bg-gray-800 text-marian-blue-600 dark:text-white border border-marian-blue-600 dark:border-white hover:bg-marian-blue-600 hover:text-white dark:hover:bg-white dark:hover:text-marian-blue-500 focus:ring-marian-blue-700',
