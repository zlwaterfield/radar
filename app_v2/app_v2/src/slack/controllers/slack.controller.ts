import { Controller, Post, Get, Body, Req, Res, Logger, UseGuards } from '@nestjs/common';
...
export class SlackController {
  ...
  async handleOAuthCallback(
    ...
    try {
      ...
      const oauthResponse = await this.slackService.handleOAuthCallback(code as string);
      ...
      const redirectUrl = new URL(`${process.env.FRONTEND_URL}/auth/slack/success`);
  ...
  @ApiResponse({ status: 200, description: 'Interaction processed successfully' })
