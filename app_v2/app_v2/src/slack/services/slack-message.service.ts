...
export class SlackMessageService {
   ...
   */
  createDigestMessage(notifications: NotificationData[], timeWindow: string): SlackMessage {
    const pullRequests = notifications.filter(n => n.type.includes('pull_request'));
