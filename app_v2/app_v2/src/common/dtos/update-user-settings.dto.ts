import { IsOptional, IsObject, IsInt, IsArray, IsString, Min, Max } from 'class-validator';
import { ApiPropertyOptional } from '@nestjs/swagger';
import { Transform, Type } from 'class-transformer';
import type { NotificationPreferences, NotificationSchedule } from '../types/user.types';
