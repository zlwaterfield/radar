import { IsObject, IsNumber, IsArray, IsOptional, Min, Max } from 'class-validator';
...
export class NotificationScheduleDto {
  ...
  @ApiProperty({ description: 'Days of week for digest', example: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'] })
  digest_days: string[];
...
export class UserSettingsResponseDto {
  ...
  @ApiProperty({ description: 'Notification schedule', type: NotificationScheduleDto })
  notificationSchedule: NotificationScheduleDto;

  @ApiProperty({ description: 'Statistics time window in days' })
  statsTimeWindow: number;

  @ApiProperty({ description: 'Keywords for filtering', example: ['bug', 'urgent'] })
  keywords: string[];
